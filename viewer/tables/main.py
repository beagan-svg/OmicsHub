...
class MainTable(tables.Table):
    ...
    organism = tables.Column(verbose_name='Organism', accessor='fastq_name.organism_name', attrs={'th': {'class': 'column_organism'}, 'td': {'class': 'column_organism'}})
    ...
    amplification_name = tables.Column(verbose_name='Amplification', accessor='fastq_name.amplification_name', attrs={'th': {'class': 'column_amplification_name'}, 'td': {'class': 'column_amplification_name'}})
