...
urlpatterns = [
    ...
    path("jobs/", job_monitor, name="job-monitor"),
    path("timeline/", job_timeline, name="job-timeline"),
    path("jobs/credentials/", job_credentials_submit, name="job-credentials-submit"),
    path("jobs/credentials/status/", job_credentials_status, name="job-credentials-status"),
    path("jobs/credentials/clear/", job_credentials_clear, name="job-credentials-clear"),
    path("jobs/<str:demand_id>/logs/", job_demand_logs, name="job-demand-logs"),
