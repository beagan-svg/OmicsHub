...
@pytest.mark.parametrize(
    ...
    [
        ...
        # The shape most of the mirror actually has — no recognised prefix at all.
...
def test_prefix_mapping_matches_the_generated_columns():
    ...
    """
    from apps.catalog.models import FALLBACK_MODALITY, FALLBACK_PREFIX, PREFIX_MODALITY
...
def test_sync_scope_includes_atx_whenever_mtx_is_configured():
    ...
    from apps.catalog.models import prefixes_for_workflows
