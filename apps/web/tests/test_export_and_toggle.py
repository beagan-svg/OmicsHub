...
class TestFamilyToggle:
    def test_filters_by_vendor_family(self, logged_in):
        ...
        response = logged_in.get(reverse("web:dashboard"), {"batch_prefix": "MTX"})
    ...
    def test_atx_is_selectable_separately_from_mtx(self, logged_in):
        ...
        response = logged_in.get(reverse("web:dashboard"), {"batch_prefix": "ATX"})
    ...
    def test_an_unknown_family_is_ignored_rather_than_erroring(self, logged_in):
        ...
        response = logged_in.get(reverse("web:dashboard"), {"batch_prefix": "NOPE"})
...
class TestStudySet:
    def test_filters_by_study(self, logged_in):
        ...
        response = logged_in.get(reverse("web:dashboard"), {"study": "SCORCH"})
...
class TestExport:
    ...
    def test_exports_the_filtered_rows_when_nothing_is_ticked(self, logged_in):
        ...
        response = logged_in.post(f"{reverse('web:export')}?batch_prefix=MTX")
    ...
    def test_a_ticked_selection_wins_over_the_filters(self, logged_in):
        ...
        response = logged_in.post(reverse("web:export"), {"fastq_names": ["A-1"]})
    ...
    def test_is_a_csv_download(self, logged_in):
        ...
        response = logged_in.post(reverse("web:export"))
    ...
    def test_headers_match_the_users_chosen_columns(self, logged_in):
        make("A-1", "10X120")
        logged_in.post(reverse("web:set-columns"), {"columns": ["fastq_name", "modality"]})

        body = self._body(logged_in.post(reverse("web:export")))
    ...
    def test_a_formula_like_value_is_defused(self, logged_in):
        ...
        logged_in.post(reverse("web:set-columns"), {"columns": ["fastq_name"]})
    ...
    def test_requires_login(self, client):
        response = client.post(reverse("web:export"))
...
class TestPairingInSubmission:
    def test_submitting_one_half_pulls_in_the_other(self, logged_in, active_config):
        ...
        response = logged_in.post(
            reverse("web:submit-review"), {"fastq_names": ["NW-MX32013-2"]}, follow=True
        )
...
class TestScopedFilters:
    ...
    def test_a_selected_batch_survives_an_empty_sync(self, logged_in):
        ...
        response = logged_in.get(
            reverse("web:dashboard"), {"batch_prefix": "MTX", "batch_name_from_vendor": "MTX-99999"}
        )
...
class TestSorting:
    ...
    def test_a_column_can_be_sorted_ascending(self, logged_in):
        ...
        response = logged_in.get(reverse("web:dashboard"), {"sort": "fastq_name", "dir": "asc"})
    ...
    def test_an_unknown_sort_key_falls_back_rather_than_erroring(self, logged_in):
        ...
        response = logged_in.get(reverse("web:dashboard"), {"sort": "password", "dir": "asc"})
    ...
    def test_sorting_keeps_the_active_tab(self, logged_in):
        ...
        response = logged_in.get(
            reverse("web:dashboard"), {"batch_prefix": "MTX", "sort": "fastq_name", "dir": "asc"}
        )
...
class TestBatchDropdownOrder:
    ...
    def test_a_kept_selection_is_placed_in_order(self, logged_in):
        ...
        response = logged_in.get(reverse("web:dashboard"), {"batch_name_from_vendor": "MTX-22099"})
...
class TestPagerKeepsFilters:
    ...
    def test_the_next_page_link_carries_the_current_filters(self, logged_in):
        ...
        response = logged_in.get(reverse("web:dashboard"), {"batch_prefix": "MTX", "sort": "load_name"})
